        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasStudyLab = table.Column<bool>(type: "bit", nullable: false),
                    HasBooks = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncludesStudyLab = table.Column<bool>(type: "bit", nullable: false),
                    StudyLabMonthlyPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IncludesTransportation = table.Column<bool>(type: "bit", nullable: false),
                    TransportationMonthlyPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    StudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AcademicPeriodId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    TransportationMonthlyFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    HasStudyLab = table.Column<bool>(type: "bit", nullable: false),
                    StudyLabMonthlyFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocxPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
